...
import { commitInspectedReservedRecordingPart, effectiveAttemptRecordMode, finalizeRecordingManifest, findNextRecordingPartIndex, findRecordingUploadReservation, getRecordingRecoveryStatus, listPendingRecordingReservations, reserveRecordingUpload, sealRecordingManifest, timestampWithoutTimezoneUtcMs, } from '../services/recordingPersistence.js';
...
function readPendingRecordingReservationsLocked(studentId, batchId) {
    ...
    try {
        ...
        if (pending.length > 0) {
            ...
            for (const reservation of pending) {
                ...
                if (!inspected || inspected.byteSize <= 0)
                    continue;
