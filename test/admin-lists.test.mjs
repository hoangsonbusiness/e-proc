...
function fixture() {
  ...
  database.exec(`
    CREATE TABLE batches (
      ...
      blueprint TEXT, record_enabled INTEGER, record_mode TEXT, vmware_check_enabled INTEGER, live_enabled INTEGER, exam_type TEXT,
    ...
    INSERT INTO batches VALUES
      (1, 'Older', '', '', 30, '[{"module":"Java"}]', 0, 'none', 1, 0, 'essay', 1, 'idle', '2026-01-01'),
      (2, 'Newer', '', '', 45, '[{"module":"Spring"}]', 0, 'none', 1, 0, 'quiz', 1, 'idle', '2026-01-02');
