# Hướng dẫn cấp quyền ghi màn hình cho thí sinh dùng macOS (MacBook)

> **Dành cho thí sinh sử dụng máy Mac / MacBook.**
> Thí sinh dùng **Windows** không cần làm theo hướng dẫn này.

## Vì sao cần làm bước này?

Bài thi **bắt buộc ghi lại màn hình** trong suốt quá trình làm bài. Trên macOS, lần **đầu tiên** trình duyệt xin quyền ghi màn hình, bạn phải:

1. Bật quyền trong cài đặt hệ thống, **và**
2. **Thoát rồi mở lại trình duyệt** thì quyền mới có hiệu lực.

Đây là quy định của macOS, không phải lỗi hệ thống thi. Nếu không làm trước, đúng lúc vào thi thật bạn sẽ buộc phải thoát trình duyệt giữa chừng → mất phiên thi.

> ⚠️ **QUAN TRỌNG:** Hãy hoàn tất hướng dẫn này trong **buổi thi thử / làm quen hệ thống**, **KHÔNG** để đến buổi thi thật. Sau khi đã cấp quyền một lần trên máy của bạn, các buổi thi sau sẽ không cần làm lại.
...
### Bước 1 — Vào trang thi và bấm "Bắt đầu làm bài"
...
> Nếu bạn chọn nhầm tab/cửa sổ, hệ thống sẽ báo:
...
1. Bấm **"Open System Settings"** trong thông báo (hoặc tự mở: **Cài đặt hệ thống → Quyền riêng tư & Bảo mật → Ghi màn hình**
...
1. Bấm **"Quit & Reopen"** nếu macOS đề nghị.
...
## Trong lúc làm bài — những điều KHÔNG được làm

- ❌ **Không bấm "Stop sharing" / "Dừng chia sẻ"** (thanh thông báo chia sẻ màn hình). Tự dừng ghi màn hình sẽ **khóa bài thi ngay lập tức**.
- ❌ Không mở ứng dụng khác đè lên (Notes, Stickies, Maccy…), không rời khỏi cửa sổ thi — đều bị ghi nhận là vi phạm.
- ❌ Không thoát toàn màn hình, không chuyển tab.
